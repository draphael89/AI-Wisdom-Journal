...
const QuizQuestion: React.FC<QuizQuestionProps> = React.memo(({ question, onAnswer, currentQuestionIndex, totalQuestions }) => {
  ...
  return (
    ...
    >
      ...
      >
        <motion.div
          className="relative backdrop-blur-2xl bg-gradient-to-br from-primary-900/30 to-secondary-900/30 rounded-3xl p-8 shadow-lg overflow-hidden border border-primary-500/20"
        ...
        >
          ...
          <div className="relative z-10">
            <motion.h2 
              ...
              className="text-3xl font-bold mb-2 text-primary-100 text-center animate-glow-pulse font-sans"
            >
              {question.text}
            </motion.h2>
            <motion.p
              variants={itemVariants}
              className="text-sm text-primary-200 text-center mb-6"
            >
            ...
            <div className="space-y-4">
              {[1, 2, 3, 4, 5].map((value) => (
                <motion.button
                  ...
                  className="w-full bg-gradient-to-r from-primary-600/40 to-secondary-600/40 hover:from-primary-500/50 hover:to-secondary-500/50 text-primary-100 font-semibold py-4 px-6 rounded-xl transition-all duration-300 ease-in-out transform hover:shadow-lg group relative overflow-hidden"
                >
                  <span className="relative z-10 group-hover:text-white transition-colors duration-300 font-sans">
